                ...
                <div className="relative group">
                   ...
                   <div className="relative">
                      ...
                      <input 
                         ...
                         className="w-full h-14 pl-14 pr-6 bg-slate-50/50 border border-slate-100 rounded-[1.5rem] focus:bg-white focus:border-blue-500 outline-none transition-all font-black uppercase text-xs tracking-widest placeholder:text-slate-200"
                      />
                   </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[300px] overflow-y-auto pr-2 scroller-airy">
                   {filteredSales.map(sale => (
                     <button
                       ...
                       className="p-6 bg-white border border-slate-50 hover:border-blue-200 rounded-[1.5rem] shadow-sm hover:shadow-xl hover:shadow-blue-50/50 transition-all text-left group flex justify-between items-center"
                     >
                        <div>
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom duration-500">
             ...
             <div className="space-y-4">
                {returnItems.map((item, index) => (
                  <div key={item.item_id} className={`p-8 rounded-[2rem] border transition-all ${item.return_quantity > 0 ? 'bg-white border-blue-200 shadow-xl ring-1 ring-blue-50' : 'bg-slate-50/50 border-slate-100'}`}>
                     ...
                     <div className="flex items-center gap-8">
                        <div className="flex items-center gap-4">
                            ...
                            <button 
                               onClick={() => handleQtyChange(index, 1)}
                               className="w-10 h-10 bg-white border border-slate-100 rounded-xl flex items-center justify-center text-slate-300 hover:text-blue-500 hover:bg-blue-50 transition-all font-black shadow-sm"
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6 border-t border-slate-50">
                       ...
                       {['cash', 'credit'].map(t => (
                         <button 
                            ...
                            className={`flex-1 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${
                               refundType === t ? 'bg-white text-blue-600 shadow-sm' : 'text-slate-400 hover:text-slate-600'
                            }`}
                         >
                            {t}
                         </button>
                ...
                <div className="space-y-2">
                   ...
                   <textarea
                      ...
                      className="w-full px-6 py-5 bg-slate-50/50 border border-slate-100 focus:bg-white focus:border-blue-500 outline-none rounded-[1.5rem] font-black uppercase text-[10px] tracking-widest placeholder:text-slate-200 h-full resize-none transition-all italic"
                   />
                </div>
             </div>
          </div>
             ...
             <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-10">
                ...
                <div className="flex gap-4 w-full md:w-auto">
                   <button
                     ...
                     className="flex-1 md:flex-none bg-blue-600 hover:bg-white hover:text-blue-600 text-white font-black py-6 px-12 rounded-[1.5rem] transition-all shadow-xl shadow-blue-500/20 active:scale-95 disabled:opacity-20 flex items-center justify-center gap-3 uppercase text-xs tracking-widest italic"
                   >
