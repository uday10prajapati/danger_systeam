...
export default function BardanEntry({ isOpen, onClose, lang = 'gu' }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
      <div className="bg-white w-[1000px] rounded-lg shadow-2xl flex flex-col max-h-[95vh] border border-gray-200 overflow-hidden">
        {/* Header */}
        ...
        <div className="flex-1 overflow-hidden flex flex-col p-6 gap-4 bg-gray-50">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-slate-900 p-4 rounded-lg shadow-lg border-l-4 border-l-rose-500">
          ...
          <div className="flex justify-between items-center pt-6 border-t border-gray-200 shrink-0">
            <div className="flex gap-2">
              <button type="button" onClick={handleNew} className="flex items-center gap-2 px-5 py-2.5 bg-sky-500 hover:bg-sky-600 text-white rounded-lg font-bold shadow-lg shadow-sky-200 transition-all active:scale-95">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4" /></svg>
                {t.buttons.new}
              </button>
              <button type="button" onClick={handleDelete} className="flex items-center gap-2 px-5 py-2.5 bg-rose-500 hover:bg-rose-600 text-white rounded-lg font-bold shadow-lg shadow-rose-200 transition-all active:scale-95">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>
                {t.buttons.delete}
              </button>
              <button type="button" onClick={fetchEntries} className="flex items-center gap-2 px-5 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg font-bold transition-all">
            ...
            <div className="flex gap-2">
              <button type="button" onClick={handlePrint} className="flex items-center gap-2 px-5 py-2.5 bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg font-bold shadow-lg shadow-indigo-200 transition-all active:scale-95">
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center gap-2 px-8 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-bold shadow-lg shadow-emerald-200 transition-all active:scale-95 disabled:opacity-50"
              >
