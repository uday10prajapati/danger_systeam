      ...
      <div className="relative">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
          {loading && (
        ...
        {showSuggestions && suggestions.length > 0 && (
          <div className="absolute z-10 w-full mt-1 bg-white border border-slate-300 rounded-2xl shadow-lg">
        ...
        {/* Error */}
        {error && (
          <div className="absolute z-10 w-full mt-1 bg-red-50 border border-red-300 rounded-2xl p-3">
