        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            {!isHome && (
              <button
                onClick={() => navigate('/')}
                className="flex items-center gap-2 px-4 py-2 hover:bg-slate-100 rounded-lg transition-all text-slate-700 font-medium"
              >
            ...
            <div className="flex items-center gap-2 px-3 py-2 bg-slate-50 rounded-lg border border-slate-200 shadow-sm">
              ...
              <button
                ...
                className={`px-3 py-1 rounded transition-all font-medium ${i18n.language === 'en'
              ...
              <button
                ...
                className={`px-3 py-1 rounded transition-all font-medium ${i18n.language === 'gu'
                    ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white'
                    : 'text-slate-600 hover:bg-slate-100'
                  }`}
              >
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-slate-50 rounded-lg border border-slate-200 shadow-sm">
              ...
              <span className="text-sm text-slate-600 font-medium">{backendStatus}</span>
            </div>
          </div>
          ...
          <div className="md:hidden mt-4 pt-4 border-t border-slate-200 space-y-2">
            {!isHome && (
              <button
                ...
                className="w-full flex items-center gap-2 px-4 py-2 hover:bg-slate-100 rounded-lg transition-all text-left text-slate-700 font-medium"
              >
                <ArrowLeft className="w-4 h-4" />
                <span>{t('navbar.backToDashboard')}</span>
              </button>
            ...
            <div className="flex items-center gap-2 px-3 py-2 bg-slate-50 rounded-lg border border-slate-200 shadow-sm">
              ...
              <button
                ...
                className={`px-3 py-1 rounded transition-all font-medium text-sm ${i18n.language === 'en'
                    ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white'
                    : 'text-slate-600 hover:bg-slate-100'
                  }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1 rounded transition-all font-medium text-sm ${i18n.language === 'gu'
                    ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white'
                    : 'text-slate-600 hover:bg-slate-100'
                  }`}
              >
