                  ...
                  <>
                    {data.map((row, idx) => (
                      <tr key={idx} className="group hover:bg-indigo-50/30 transition-all duration-300">
                        ...
                        <td className={`px-10 py-5 text-right font-black text-sm italic underline underline-offset-8 decoration-4 ${
                          parseFloat(row.closing_balance) >= 0 ? 'text-emerald-600 decoration-emerald-50' : 'text-rose-600 decoration-rose-50'
                        }`}>
