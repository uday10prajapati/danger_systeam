             ...
             <div className="flex gap-1.5 p-1.5 bg-white rounded-2xl border border-slate-100 shadow-sm">
                <button 
                  ...
                  className={`px-6 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all ${
                    activeTab === 'scan' ? 'bg-blue-600 text-white shadow-lg shadow-blue-100' : 'text-slate-400 hover:text-slate-600'
                  }`}
                >
                  Live Scanner
                </button>
                <button 
                  ...
                  className={`px-6 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all ${
                    activeTab === 'manage' ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-100' : 'text-slate-400 hover:text-slate-600'
                  }`}
                >
                  Manifest Control
                </button>
        ...
        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden flex flex-col min-h-[650px] relative">
          ...
          {(successMessage || errorMessage) && (
            <div className="absolute top-8 left-1/2 -translate-x-1/2 z-[100] w-full max-w-md px-4">
               <div className={`p-4 rounded-2xl shadow-2xl flex items-center gap-3 animate-in slide-in-from-top-4 duration-500 ${
                  successMessage ? 'bg-blue-600 text-white' : 'bg-rose-600 text-white'
               }`}>
                           ...
                           {allItems
                              ...
                              .map((item, idx) => (
                                 <tr key={item.id} className="group hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td className="px-10 py-6">
                                       <div className={`px-4 py-2 rounded-xl border font-mono text-[11px] font-bold w-fit ${
                                          item.barcode ? 'bg-slate-900 text-white border-slate-800 tracking-[0.2em]' : 'bg-slate-50 text-slate-300 border-slate-100 italic'
                                       }`}>
