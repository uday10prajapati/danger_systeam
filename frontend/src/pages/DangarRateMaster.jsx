            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-300">
               <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-md overflow-hidden border border-slate-100 animate-in zoom-in-95 duration-300">
                  <div className="p-8 border-b border-slate-50 flex items-center justify-between">
                     <div className="flex items-center gap-4">
                        <div className="p-3 bg-blue-600 text-white rounded-2xl shadow-lg ring-4 ring-blue-500/5"><Calendar size={20} /></div>
                        <div>
                  ...
                  <form onSubmit={handleCreateSeason} className="p-10 space-y-6">
                     ...
                     <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                           ...
                           <input
                              ...
                              className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-100 focus:bg-white focus:border-blue-500 rounded-xl outline-none transition-all font-bold text-slate-700 text-sm italic"
                           />
                        </div>
                     </div>
                     ...
                     <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                           ...
                           <select
                              ...
                              className="w-full px-5 py-3 bg-slate-50 border border-slate-100 focus:bg-white focus:border-blue-500 rounded-xl outline-none font-bold text-slate-700 appearance-none uppercase text-xs tracking-wider"
                           >
                        ...
                        <div className="space-y-1.5">
                           ...
                           <input
                              ...
                              placeholder="2026-27"
                              className="w-full px-5 py-3 bg-slate-50 border border-slate-100 focus:bg-white focus:border-blue-500 rounded-xl outline-none transition-all font-bold text-slate-700 text-sm font-mono text-center"
                           />
                        </div>
                     </div>
                     ...
                     <button
                        type="submit"
                        disabled={isSaving}
                        className="w-full mt-4 flex items-center justify-center gap-3 bg-slate-900 text-white font-black uppercase tracking-[0.2em] text-[10px] py-4 rounded-2xl hover:bg-blue-600 transition-all shadow-xl shadow-slate-200 active:scale-95 disabled:bg-slate-300"
                     >
