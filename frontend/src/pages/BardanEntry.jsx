            ...
            <div className="bg-white/80 backdrop-blur-xl p-10 rounded-lg border border-white shadow-2xl space-y-8 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="space-y-3">
                  ...
                  <select
                    name="bookType"
                    className="w-full px-6 py-4 bg-slate-50/50 border border-slate-100 rounded-lg focus:bg-white focus:border-rose-500 outline-none transition-all font-black italic text-sm text-slate-700 appearance-none shadow-inner uppercase"
                ...
                <div className="space-y-3">
                  ...
                  <input
                    type="date"
                    name="date"
                    className="w-full px-6 py-4 bg-slate-50/50 border border-slate-100 rounded-lg focus:bg-white focus:border-rose-500 outline-none transition-all font-black italic text-sm text-slate-700 shadow-inner"
                    value={formData.date}
                    onChange={handleChange}
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    ...
                    <select
                      name="code"
                      className="w-full pl-14 pr-6 py-4 bg-slate-50/50 border border-slate-100 rounded-lg focus:bg-white focus:border-rose-500 outline-none transition-all font-black text-sm text-slate-700 appearance-none shadow-inner uppercase italic"
                      value={formData.code}
                      onChange={handleChange}
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-3">
                  ...
                  <select
                    name="memNominal"
                    className="w-full px-6 py-4 bg-slate-50/50 border border-slate-100 rounded-lg focus:bg-white focus:border-rose-500 outline-none transition-all font-black italic text-sm text-slate-700 shadow-inner appearance-none uppercase"
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-white/90 backdrop-blur-xl p-8 rounded-lg border border-white shadow-2xl flex flex-col h-[600px]">
              <div className="flex items-center gap-4 mb-6">
                <div className="p-3 bg-rose-50 text-rose-500 rounded-lg shadow-inner">
                  <Layout size={20} />
                </div>
                <div>
                    ...
                    {gridRows.map((row, i) => (
                      <tr key={i} className="group">
                        ...
                        <td className="px-1 py-1">
                          <input
                            className="w-full bg-slate-50 border-none rounded-lg px-3 py-2.5 font-bold text-slate-700 outline-none focus:bg-white focus:ring-2 focus:ring-rose-500/20 transition-all font-mono"
                            value={row.col1}
                            onChange={(e) => {
