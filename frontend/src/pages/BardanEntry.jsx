  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-12 animate-in fade-in duration-700">
            ...
            <div className="bg-white/80 backdrop-blur-xl p-10 rounded-[3rem] border border-white shadow-2xl space-y-8 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="space-y-3">
                  ...
                  <select
                    name="bookType"
                    className="w-full px-6 py-4 bg-slate-50/50 border border-slate-100 rounded-2xl focus:bg-white focus:border-rose-500 outline-none transition-all font-black italic text-sm text-slate-700 appearance-none shadow-inner uppercase"
                ...
                <div className="space-y-3">
                  ...
                  <input
                    name="pavtiNo"
                    className="w-full px-6 py-4 bg-slate-50/50 border border-slate-100 rounded-2xl focus:bg-white focus:border-rose-500 outline-none transition-all font-black text-sm text-slate-700 shadow-inner italic"
                ...
                <div className="space-y-3">
                  ...
                  <input
                    type="date"
                    name="date"
                    className="w-full px-6 py-4 bg-slate-50/50 border border-slate-100 rounded-2xl focus:bg-white focus:border-rose-500 outline-none transition-all font-black italic text-sm text-slate-700 shadow-inner"
                    value={formData.date}
                    onChange={handleChange}
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    <User className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-rose-500 transition-colors" size={18} />
                    <select
                      name="code"
                      className="w-full pl-14 pr-6 py-4 bg-slate-50/50 border border-slate-100 rounded-2xl focus:bg-white focus:border-rose-500 outline-none transition-all font-black text-sm text-slate-700 appearance-none shadow-inner uppercase italic"
                      value={formData.code}
                      onChange={handleChange}
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    <Package className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-rose-500 transition-colors" size={18} />
                    <input
                      type="number"
                      name="qty"
                      className="w-full pl-14 pr-6 py-4 bg-slate-50/50 border border-slate-100 rounded-2xl focus:bg-white focus:border-rose-500 outline-none transition-all font-black text-sm text-slate-700 shadow-inner italic"
                      placeholder="0.00"
                      value={formData.qty}
                      onChange={handleChange}
                    />
                ...
                <div className="space-y-3">
                  ...
                  <select
                    name="memNominal"
                    className="w-full px-6 py-4 bg-slate-50/50 border border-slate-100 rounded-2xl focus:bg-white focus:border-rose-500 outline-none transition-all font-black italic text-sm text-slate-700 shadow-inner appearance-none uppercase"
              ...
              <div className="space-y-3">
                ...
                <div className="relative group">
                  ...
                  <textarea
                    name="remark"
                    className="w-full pl-14 pr-6 py-4 bg-slate-50/50 border border-slate-100 rounded-2xl focus:bg-white focus:border-rose-500 outline-none transition-all font-black text-sm text-slate-700 min-h-[100px] shadow-inner font-mono italic"
                    ...
                    {gridRows.map((row, i) => (
                      <tr key={i} className="group">
                        ...
                        <td className="px-1 py-1">
                          <input
                            className="w-full bg-slate-50 border-none rounded-xl px-3 py-2.5 font-bold text-slate-700 outline-none focus:bg-white focus:ring-2 focus:ring-rose-500/20 transition-all font-mono"
                            value={row.col1}
                            onChange={(e) => {
              ...
              <div className="space-y-4 pt-6 border-t border-slate-100">
                ...
                <div className="flex justify-between items-center text-rose-500">
                  ...
                  <input
                    type="number"
                    name="totalQty"
                    className="w-32 text-right bg-rose-50/50 border border-rose-100 rounded-xl px-3 py-3 text-2xl font-black italic tracking-tighter"
      ...
      <style dangerouslySetInnerHTML={{
        ...
        .custom-scroller::-webkit-scrollbar-thumb { background: #fecdd3; border-radius: 10px; }
        .custom-scroller:hover::-webkit-scrollbar-thumb { background: #f43f5e; }
      `}} />
    </div>
  );
};

export default BardanEntry;
