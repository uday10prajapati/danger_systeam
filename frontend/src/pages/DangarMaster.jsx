  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-12 animate-in fade-in duration-700">
      <div className="max-w-[1600px] mx-auto px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center py-8 gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="p-3.5 bg-white text-slate-400 hover:text-blue-600 rounded-2xl border border-slate-100 shadow-sm transition-all active:scale-95"
            >
        ...
        {/* Dynamic Filters */}
        <div className="bg-white/80 backdrop-blur-xl p-6 rounded-[2.5rem] border border-slate-100 shadow-sm mb-8 flex flex-wrap items-center gap-8">
        ...
        <div className="bg-white rounded-[3rem] border border-slate-100 shadow-2xl overflow-hidden min-h-[600px] flex flex-col">
          <div className="p-8 border-b border-slate-50 flex items-center justify-between bg-slate-50/30">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-white rounded-3xl flex items-center justify-center text-slate-800 shadow-xl border border-slate-100">
                <Database size={24} />
              </div>
              <div>
          ...
          <div className="overflow-x-auto flex-1">
            {loading ? (
              ...
              <div className="h-[400px] flex flex-col items-center justify-center gap-6">
                 <div className="w-24 h-24 bg-slate-50 border border-slate-100 rounded-[3rem] flex items-center justify-center text-slate-200">
                    <Box size={48} />
                 </div>
                  ...
                  {filteredEntries.map((row) => (
                    <tr key={row.id} className="group hover:bg-slate-50 transition-all duration-300">
                      <td className="px-8 py-6">
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center font-black group-hover:bg-blue-600 group-hover:text-white transition-all shadow-inner">
                            {row.member_name?.[0]}
                          </div>
                          <div>
                      ...
                      <td className="px-8 py-6">
                         <div className="flex justify-center">
                            <span className="px-3 py-1 bg-emerald-50 text-emerald-600 text-[9px] font-black uppercase tracking-widest rounded-2xl border border-emerald-100 animate-pulse">Committed</span>
                         </div>
                      </td>
                    </tr>
                  ))}
          ...
          <div className="p-8 bg-slate-900 border-t border-slate-800 flex justify-between items-center shrink-0">
             <div className="flex items-center gap-8">
                ...
                <div className="flex flex-col bg-white/5 px-8 py-3 rounded-3xl border border-white/5">
             ...
             <div className="flex items-center gap-4">
                <button className="flex items-center gap-2 px-6 py-3 bg-white/10 hover:bg-white/20 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl transition-all border border-white/5 active:scale-95">
