...
function CompanySetup() {
  ...
  const handleAddYear = async (e) => {
    ...
    try {
      ...
      setSuccess(true);
      setIsEditing(false); // Using isEditing instead of setShowYearForm
      setNewYear({ label: '', start: '', end: '' });
      setEditingYear(null);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-white rounded-lg border border-slate-100 shadow-sm p-10 group overflow-hidden relative">
                ...
                <div className="flex flex-col md:flex-row items-center gap-4 mb-10 relative z-10 text-center md:text-left">
