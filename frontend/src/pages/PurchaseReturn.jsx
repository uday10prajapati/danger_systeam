        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
          ...
          <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm group hover:border-amber-200 transition-all">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="p-2 bg-amber-50 rounded-xl text-amber-600"><User size={16} /></div>
            </div>
        ...
        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden flex flex-col min-h-[600px]">
          <div className="p-8 pb-4 flex flex-wrap items-center justify-between gap-6">
            ...
            <div className="flex gap-1.5 p-1 bg-slate-50 rounded-2xl border border-slate-100">
              <button className="px-5 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all bg-white text-blue-600 shadow-sm">All Registers</button>
              <button className="px-5 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all text-slate-400 hover:text-slate-600">Pending Reconciliation</button>
            </div>
          </div>
                    ...
                    <tr key={ret.id} className="group hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-10 py-6">
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 rounded-2xl bg-amber-50 text-amber-600 flex items-center justify-center font-bold text-[10px] uppercase">
            ...
            <div className="flex-1 overflow-y-auto p-10 space-y-10">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {[
                  ...
                  <div key={i} className="bg-slate-50 p-5 rounded-[2.5rem] border border-slate-100 group hover:bg-white transition-all">
