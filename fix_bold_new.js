...
applyBoldFix(path.resolve('frontend/src/pages/InterestCalculator.jsx'));
applyBoldFix(path.resolve('frontend/src/pages/Sale.jsx'));
applyBoldFix(path.resolve('frontend/src/pages/ItemRate.jsx'));
applyBoldFix(path.resolve('frontend/src/pages/SaleReport.jsx'));
